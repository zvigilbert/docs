...
!!! tip You can also control who is notified of which types of alerts from the _Environments \> Settings_ screen. Select the environment tab at the top, then check the names of the desired users under _Notify of Alerts_.

!!! note You must have at least one _Notifications_ user and one _Support general_ user. These can be the same user.